/*
    ...
    (But change the script src URL to wherever you have this widget stored on your site!)
        ...
        <div id="c_widget"></div>
        <script src="/Main/Fax/comment-widget-dark/comment-widget.js"></script>
...
const s_stylePath = '/Main/Fax/comment-widget-dark/comment-widget-dark.css';
const s_formId = '1FAIpQLScyBK8quW22c01jeBVQJoyAuApBH7DXJf3Apph1e4ONHFyXBA';
const s_nameId = '521195403';
const s_websiteId = '1990016293';
const s_textId = '1194184212';
const s_pageId = '365148374';
const s_replyId = '301547189';
const s_moderatedId = '8790992'; // The Moderated field ID
const s_sheetId = '1PBBewyEuvzF2jUiJs36VucsCpgRVwO2hVhS9Todm5_I';
...
const s_widgetTitle = '<font color="red">A</font> <font color="orange">R</font><font color="yellow">E</font><font color="green">P</font><font color="blue">R</font><font color="purple">E</font><font color="hotpink">S</font><font color="red">E</font><font color="orange">N</font><font color="yellow">T</font><font color="green">A</font><font color="blue">T</font><font color="purple">I</font><font color="hotpink">V</font><font color="red">E</font> <font color="orange">W</font><font color="yellow">I</font><font color="green">L</font><font color="blue">L</font> <font color="purple">B</font><font color="hotpink">E</font> <font color="red">W</font><font color="orange">I</font><font color="yellow">T</font><font color="green">H</font> <font color="blue">Y</font><font color="purple">O</font><font color="hotpink">U</font> <font color="red">S</font><font color="orange">H</font><font color="yellow">O</font><font color="green">R</font><font color="blue">T</font><font color="purple">L</font><font color="hotpink">Y</font>.';
const s_nameFieldLabel = '<u><i><mark>Name</u>:</i></mark>';
const s_websiteFieldLabel = '<u><i><mark>Website</u>:</i></mark>';
const s_textFieldLabel = '';
const s_submitButtonLabel = 'SEND';
const s_loadingText = 'LOADING ENTRIES...';
const s_noCommentsText = 'NO ENTRIES...';
const s_closedCommentsText = 'THE FAX MACHINE IS JAMMED, COME BACK LATER.';
const s_websiteText = 'Website'; // The links to websites left by users on their comments
const s_replyButtonText = 'RESPOND'; // The button for replying to someone
const s_replyingText = 'RESPONDING TO...'; // The text that displays while the user is typing a reply
const s_expandRepliesText = 'SHOW RESPONSES';
...
function createComment(data) {
    ...
    if(data.Moderated == false) {
        name.innerText = 'UNKNOWN NUMBER'; // Change 'Guest' to whatever you want
    }
    ...
    if(data.Moderated == false) {
        text.innerText = 'PLEASE HOLD.. YOUR ANSWER WILL BE PUBLISHED AFTER APPROVAL.'; // Change this value to whatever you want
    }
